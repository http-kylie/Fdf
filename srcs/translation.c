 ...
 *
 * If the keycode is W_KEY, the y-axis shift is decreased.
 * If the keycode is A_KEY, the x-axis shift is decreased.
 * If the keycode is S_KEY, the y-axis shift is increased.
 * If the keycode is D_KEY, the x-axis shift is increased.
 *
